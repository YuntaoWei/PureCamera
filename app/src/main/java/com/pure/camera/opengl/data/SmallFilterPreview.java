...
public class SmallFilterPreview {
    ...
    private void initialVertex() {
        ...
        for (int i = 0; i < filterCount; i++) {
            LogPrinter.i("ccc", "currentStartX : " + currentStartX);
            //顶点1
            coords[coordsPerRectangle * i] = currentStartX;
            coords[coordsPerRectangle * i + 1] = -0.5f + height;
            coords[coordsPerRectangle * i + 2] = 1f;
            coords[coordsPerRectangle * i + 3] = 1f;
            //顶点2
            coords[coordsPerRectangle * i + 4] = currentStartX - DEFAULT_WIDTH;
            coords[coordsPerRectangle * i + 5] = -0.5f + height;
            coords[coordsPerRectangle * i + 6] = 0f;
            coords[coordsPerRectangle * i + 7] = 1f;
            //顶点3
            coords[coordsPerRectangle * i + 8] = currentStartX;
            coords[coordsPerRectangle * i + 9] = -0.5f;
            coords[coordsPerRectangle * i + 10] = 1f;
            coords[coordsPerRectangle * i + 11] = 0f;
            //顶点4
            coords[coordsPerRectangle * i + 12] = currentStartX - DEFAULT_WIDTH;
            coords[coordsPerRectangle * i + 13] = -0.5f;
